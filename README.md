...
![Снимок](https://github.com/user-attachments/assets/0bcdd313-ea17-47be-94a4-00dc8f472a83)
...
Пример ручного вывода информации с платы дистанционного питания MGS-4.
...
* ✅ Поддержка до **5 устройств** одновременно
...
![Снимок1](https://github.com/user-attachments/assets/c15f269d-d577-4311-9fb9-44f852f68a04)
...
![Снимок3](https://github.com/user-attachments/assets/5515011c-6104-4357-9410-09c89bf15de6)
...
![3](https://github.com/user-attachments/assets/88105d87-be8f-4760-be82-489dbff12644)

---

## 📎 Пример ручного получения данных вручную (альтернатива автоматизации)

1. Подключение по Telnet к модему
2. Ввод команды `2`
...
6. Команда `SHOW` → отображение параметров:
   ...
   * `Status`, `Uptime`, `Voltage`, `Current`, `Leak Current`
   ...
   Для получения данных температуры:
1. Подключение по Telnet к модему
2. Ввод команды `2`
3. Ввод команды `STATUS`→ отображение параметров:
   * `Temperature`
---
